...
/*Selesai Menampilkan Tanggal*/?>
					...
					<div class="card-body">
								...
								<tbody>
									...
									<tr>
										...
										<td>
											...
											<td>
												<?php $pangkat = $pegawai->PANGKATBERIKUTNYA;
                        if ($pangkat == '-') {
                          echo "-";
                        } else {
                          echo date('d-m-Y',strtotime($pangkat));
                        }
                        ?>
											</td>
											<td>
                        <?php $KPB = date('Y-m-d H:i:s', strtotime($pegawai->PANGKATBERIKUTNYA)) ?>
                        <div class="container">
                        ...
                        <script>
											      var endDate<?php echo $i; ?> = new Date("<?php echo $KPB?>").getTime(),
